  ...
  return (
    <>
      <div className="flex gap-4">
        <button
          className="flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 hover:bg-primary/15 bg-primary hover:text-black text-wh border border-primary"
        >
          Sign Up
          <svg
            width="23"

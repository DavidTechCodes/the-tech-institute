        ...
        <section>
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
                    <div className={`col-span-12 bg-newsletter-bg-2 bg-contain bg-no-repeat`}>
                        <div className="mb-10 mt-24 lg:mx-64 lg:my-24">
                            ...
                            <h3 className="text-base font-normal text-white/75 text-center mb-8">
                                Subscrible to our newsletter for discounts, <br /> promo and many more.
                            </h3>
                            <div>
                                <div className="relative text-white focus-within:text-white flex flex-row-reverse rounded-full pt-5 lg:pt-0">
                                    <input type="Email address" name="q" className="py-6 lg:py-8 text-sm md:text-lg w-full mx-3 text-white/75 rounded-full pl-8 focus:outline-none focus:text-white" placeholder="Enter your email address" autoComplete="off" />

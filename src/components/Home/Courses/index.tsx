...
const Courses = () => {
 ...
 const settings = {
  ...
  speed: 8000,          // 👈 higher = slower, smoother movement
  cssEase: "linear",    // 👈 continuous motion

  pauseOnHover: true,  // optional (UX-friendly)
  pauseOnFocus: true,
        ...
        <section id="courses">
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4'>
                <div className="sm:flex justify-between items-center mb-20">
                    <h2 className="text-white text-4xl lg:text-5xl font-semibold mb-5 sm:mb-0">Popular courses.</h2>
